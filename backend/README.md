...
## Project Structure
    ...
    ├── trisl_notification_31888  # Django project configurations
...
1. Clone this repo and `cd trisl_notification_31888`
...
2. Clone this repo and `cd trisl_notification_31888`
